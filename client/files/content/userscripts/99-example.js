...
function ExampleMakeModal()
{
	...
	out += '<p>This is example user defined modal window from file located at ' + air.File.applicationDirectory.resolvePath("userscripts/99-example.js").nativePath + '</p>';
	...
	out += '</ul></p><p>Check scripts/0-common.js for helper functions like createModalWindow, addToolsMenuItem, addKeybBind, showAlert, etc</p>';
	out += '<p>To instantiate class from client.swf use swmmo.getDefinitionByName method, for example swmmo.getDefinitionByName("Communication.VO::dUniqueID")</p>';
