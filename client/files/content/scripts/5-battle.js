	...
	try {
		...
		if(battleWindow.withFooter(".armySaveTemplate").length == 0) {
			battleWindow.Footer().prepend([
				...
				$('<button>').attr({ "class": "btn btn-primary battleAddBuff", 'data-toggle': "tooltip", 'data-placement': "top", 'title': getText("add_buff_desc") }).html($('<img>', { 'src': 'images/iconaddbuff.png' })).click(function() { 
