...
const baseTranslation = { 
	...
	'ru-ru': {
		...
		'buff_welcome_block': '<p>Вы можете записать то что вам нужно бафнуть и потом делать это в автоматическом режиме. Нажмите "Начать запись" и бафате свои или дружеские здания. После этого вернитесь сюда и нажмите кнопку "Остановить запись". Вы увидите список зданий и бафов. Сохраните его как шаблон. В следующий раз загрузите шаблон, проверьте список и нажмите "Отправить".</p><p>Здания с статусом, отличным от "готов" не будут бафнуты. Если у вас не хватает бафов на все здания, то часть не будет бафнута.</p>',
