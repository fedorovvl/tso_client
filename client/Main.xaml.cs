    ...
    public partial class Main : Window, INotifyPropertyChanged
    {
        ...
        private void run_tso(bool fast = true)
        {
            ...
            try
            {
                ...
                System.Diagnostics.Process.Start(string.Format("{0}\\client{1}.exe", ClientDirectory, _settings.x64 ? "64" : ""), string.Format("{0}&version={1}{2}", _settings.tsoArg, appversion, extraVersion));
            } catch
            {
